...
public class T3Z3Random {
    public static String gen(){
        ...
        varNum = varNum.concat(String.valueOf(random.nextInt(15)+1) + "-");//6 параметр 1 таблица
        ...
        varNum = varNum.concat(String.valueOf(random.nextInt(7)+1) + "-");//9 параметр 1 таблица
