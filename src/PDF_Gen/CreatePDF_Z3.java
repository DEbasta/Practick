...
public class CreatePDF_Z3 extends  AbstractCreatePDF{
    ...
    public void create() throws IOException, DocumentException, URISyntaxException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream("Variant_DZ3_" + key + ".pdf"));

        String[] tmpArray;
        tmpArray = new String[numberOfFinalParam];

        tmpArray = VarParse.specialParseDZ3(array);

        document.open();

        Paragraph varStringPDF=new Paragraph("Номер Варианта : " + String.valueOf(key),new Font(times,fontSize14));
        // строки ТЗ для ДЗ
        ...
        PdfPTable table5_3 = new PdfPTable(4);
