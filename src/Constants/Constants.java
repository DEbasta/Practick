...
public class Constants {
    ...
    public static final String[] getHeadersDZ3T1 = {"Тср, час", "Серия м-схем, шт.","Температура для\n" +
            "всех ЭК,","Кол-во металл-\n" + "ых отверстий, шт.","Разъем, кол-во, кол-\n" + "во контактов, шт.","Условия эксплуатации","Отн. влажность, %, высота\n" + " над уров. моря, км."};

    public static final String[] getHeadersDZ3T2 = {"Конденсатор, шт.","Паяное соединение, шт.","Печ-ый проводник, шт.","Плата, шт.","Диоды, шт.","Переключатель, шт.","Резистор, шт.","Реле, шт."};
