...
public class Constants {
    ...
    public static final String [] rowDZ2ppMaterial = {"НФД", "СТЭ", "СТЭФ", "СФ"};

    public static final String [] rowDZ2vibration = {"от 1 до 200 (аппаратура, транспортируемая\n" +
            "на автомобильном, дорожном транспорте, и\n" +
            "на морских и речных судах)", "от 1 до 300 (аппаратура, транспортируемая\n" +
            "на железнодорожном транспорте)", "от 1 до 500 (аппаратура, транспортируемая\n" +
            "на самолете)", "от 1 до 700 (аппаратура, транспортируемая\n" +
            "на гусеничном транспорте)"};

    public static final String [] rowDZ2razType = {"DS1021-1x10 SF16", "DS1021-1x10 SF116", "DS1021-1x10 SF149", "DS1021-1x10 SF11"};

    public static final String [] rowDZ2mppMaterial = {"ФТС-1-35А", "ФДМЭ-2А", "ФДМ-1А", "СТФ-1-35", "ДФО-1", "ДФС-1", "СТНФ-1-35"};

    public static final String [] rowDZ2T6ppMaterial = {"НФД", "СТЭ", "СТЭФ", "СФ", "ФТС-1-35А", "ФДМЭ-2А", "ФДМ-1А", "СТФ-1-35", "ДФО-1", "ДФС-1"};
    ...
    public static final String[] rowDZ3T4schemeSeries = {"К555", "K101", "KP127", "K580", "K145", "KP140", "K171", "K124", "K237", "K224", "K538", "K161", "KP513", "K155", "KP521"};

    public static final String[] rowDZ3T4raz = {"СНП17", "ГРПМШ1", "СНО", "РПН10", "ГРПМ", "РСТВ", "СШР", "РПС", "РПН7", "ГРПП3", "PTF", "СНП", "РППМ17", "СНЦ22", "СНП"};

    public static final String[] rowDZ3T4condens = {"К10-17", "К50-35", "К10-19", "К10-26", "К10-38", "К15-4", "К15-13", "К21-7", "К26-4", "К31-14", "К42-18", "К70-6", "К73-31", "К77-4", "К75-54"};

    public static final String[] rowDZ3T4connection = {"с печатным монтажом", "с объемным монтажом"};

    public static final String[] rowDZ3T4diod = {"2Д102", "2Д103", "2Д104", "КД105", "2Д123", "2Д204", "2Д210", "2Д212", "2Д213", "КД226", "2Д219", "2Д245", "КД209", "2Д231", "2Д251"};

    public static final String[] rowDZ3T4switcher = {"ПДМ1", "ПГ39", "ПП9", "11ПКМ49-1", "ВДМ3", "ВДМ5", "МПН-1", "МПВ-1-1", "П2Г3", "ПГ2", "ПГ43", "ПКИ", "ПП11", "ПП21", "ПР2"};

    public static final String[] rowDZ3T4resistor = {"МЛТ", "МТ", "ОМЛТ", "ПЭ", "ПЭВТ", "Р1-4", "РП1-46", "С2", "СП"};

    public static final String[] rowDZ3T4relay = {"РБП", "РНЕ", "РКМП", "РМУГ", "РПА", "РПВ2", "РЭН29", "РЭС9", "РЭС15", "РЭС22", "РЭС32", "РЭС39", "РЭС43", "РЭС49", "РЭС55"};
